...
import type { B2BOrder, B2BPaymentMethod, WholesellerOrderFilter } from './wholesellerTypes';
...
export type InventoryDraft = { salePrice: string; stockQuantity: string; reorderLevel: string };

export const PAYMENT_METHODS: B2BPaymentMethod[] = ['BANK_TRANSFER', 'UPI', 'CARD', 'CASH_ON_DELIVERY'];

export const ORDER_FILTERS: Array<{ key: WholesellerOrderFilter; label: string }> = [
  { key: 'ALL', label: 'All' },
...
export function nextB2BStatus(order: B2BOrder): 'DISPATCHED' | 'DELIVERED' | null {
...
export function matchesFilter(order: B2BOrder, filter: WholesellerOrderFilter) {
